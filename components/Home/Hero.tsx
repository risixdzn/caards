    ...
    return (
        <section className='w-full h-[90vh] rounded-lg border-border border-[1px] relative overflow-clip flex items-center justify-center'>
            <div id='herocontent' className='z-[3] flex flex-col items-center gap-3'>
                ...
                <h1 className='text-center font-heading font-semibold tracking-tight leading-10 lg:leading-[5.5rem] text-[2.5rem] lg:text-[4.5rem]'>
                    Flash{" "}
                    <Image
                        src={Cards}
                        alt=''
                    ...
                    />{" "}
                    Cards
                    <br></br>powered by <span className='text-caards'>AI</span>
                </h1>
                ...
                <div className='flex gap-6 mt-4 lg:mt-8'>
                    <Button
                        variant={"secondary"}
                        className='bg-background lg:px-7 lg:text-xl lg:py-6 border-[1px] text-muted-foreground/70 shadow-md'
                    >
                        See more
                    </Button>
                    <Button className='lg:px-7 lg:text-xl lg:py-6 shadow-md'>Get started</Button>
                </div>
            ...
            <div
                id='glows_overlay'
                className='absolute bg-no-repeat w-full bg-hero-glows bg-cover bg-center h-full z-[2]'
            ></div>
            <div
                id='corner-gradient'
                className='hidden lg:block z-[2] absolute blur-[150px] w-[57rem] h-[44rem] rounded-[50%] bg-caards
                bottom-0 translate-y-[40%] left-0 -translate-x-[40%]'
            ></div>
            <div
                id='middle-gradient'
                className='z-[2] absolute blur-[100px] lg:blur-[150px] w-[26rem] h-[44rem] rounded-[50%] bg-caards lg:bg-caards-light
                bottom-0 left-1/2 -translate-x-[50%] translate-y-[75%] lg:translate-y-[85%] '
            ></div>
            <div
                id='corner-gradient'
                className='hidden lg:block z-[2] absolute blur-[150px] w-[57rem] h-[44rem] rounded-[50%] bg-caards  
            ...
            <div
                id='squarespattern'
                className='absolute w-full h-full bg-hero-pattern2px bg-center lg:bg-auto bg-[length:48px] z-[1]'
            ></div>
            <div
                id='bg-rounded-center-gradient'
                className='blur-[40px] w-[14rem] h-[14rem] lg:w-[28rem] lg:h-[28rem] bg-neutral-200 rounded-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'
            ></div>
        </section>
    );
}
