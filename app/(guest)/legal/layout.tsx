...
export default function MdxLayout({ children }: { children: React.ReactNode }) {
    return (
        <>
            <div
                id='gradient'
                className='absolute bg-gradient-to-r from-caards-light/40 to-caards/40 w-full h-[30rem] z-0'
            >
                <div
                    id='blackoverlay'
            ...
            <main className='max-w-7xl mx-auto z-10 relative px-6 pt-36'>
                ...
                <div className='flex gap-4 items-center mt-16 flex-wrap'>
                    <a
                        id='badge'
                        className='px-6 py-2 text-xs bg-gradient-to-br rounded-full  from-caards-light/90 to-caards/90 text-white'
                    >
                        Legal terms
                    </a>
